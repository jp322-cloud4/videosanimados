...
const marcosAvatar = "https://i.ibb.co/60nSSDFB/images-5.webp";
const brunaAvatar = "https://i.ibb.co/whDcMPsG/Biogenesis-mulher.webp";
const sandroAvatar = "https://i.ibb.co/Z6z8zW7z/images-7-1.webp";
...
export default function Testimonials() {
  ...
  const testimonials = [
    {
      id: 1,
      contact: {
        name: "Marcos (Pizzaria Di Roma)",
        avatar: marcosAvatar,
        status: "online"
      },
      messages: [
        { sender: "buyer", text: "Cara, comprei aquele pacote de vídeos 3D ontem à noite e já postei o primeiro reel hoje cedo no insta!", time: "09:12" },
        { sender: "seller", text: "Excelente, Marcos! Me conta, como foi o engajamento dele?", time: "09:15" },
        { sender: "buyer", text: "Mano, bizarro total! Em menos de 4 horas bateu mais de 3 mil visualizações! Geral comentando querendo pizza de pepperoni kkkk", time: "09:18" }
      ]
    },
    {
      id: 2,
      contact: {
        name: "Bruna Silva (Pizzaria)",
        avatar: brunaAvatar,
        status: "online"
      },
      messages: [
        { sender: "buyer", text: "Queria agradecer muito pelo pack. Eu era super travada pra criar postagens bonitas de pizza...", time: "11:40" },
        { sender: "seller", text: "Olá Bruna! Tudo bem? Fico muito feliz! Deu pra usar bem os videos ?", time: "11:42" },
        { sender: "buyer", text: "Simm! Foi ridículo de fácil. Coloquei nossa logo por cima e a oferta do combo. O whatsapp tá lotado de gente perguntando se entregamos em bairros vizinhos!", time: "11:45" }
      ]
    },
    {
      id: 3,
      ...
      messages: [
        { sender: "buyer", text: "Passando pra deixar meu feedback oficial. Sou Dono de 3 pizzarias aqui da região e comprei o pack de videos.", time: "16:05" },
  ...
  return (
    <section id="testimonials" className="bg-white pt-10 pb-4 md:pt-14 md:pb-6 px-4 border-b border-orange-100 overflow-hidden">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="relative flex flex-col items-center max-w-[360px] xs:max-w-[380px] mx-auto w-full">
          ...
          <button
            onClick={handlePrev}
            className="absolute top-1/2 -left-12 -translate-y-1/2 bg-pizza-charcoal text-white hover:bg-pizza-red hover:scale-110 p-3 rounded-full shadow-lg transition-all duration-300 active:scale-95 cursor-pointer z-20 border border-orange-200/20"
            aria-label="Anterior"
          >
          ...
          <button
            onClick={handleNext}
            className="absolute top-1/2 -right-12 -translate-y-1/2 bg-pizza-charcoal text-white hover:bg-pizza-red hover:scale-110 p-3 rounded-full shadow-lg transition-all duration-300 active:scale-95 cursor-pointer z-20 border border-orange-200/20"
            aria-label="Próximo"
          >
