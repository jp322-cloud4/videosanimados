...
export default function Guarantee({ onScrollToPlans }: GuaranteeProps) {
  return (
    <section id="guarantee" className="bg-white pt-4 pb-16 md:pt-6 md:pb-24 px-4 border-b border-orange-100">
      <div className="max-w-4xl mx-auto bg-gradient-to-br from-dough-beige to-orange-50 border border-orange-200/60 rounded-3xl p-8 md:p-12 relative overflow-hidden shadow-sm flex flex-col md:flex-row gap-8 items-center">
        
        {/* Background decorative badge */}
        <div className="absolute right-0 bottom-0 opacity-5 -mr-10 -mb-10 pointer-events-none">
          <ShieldCheck className="w-96 h-96 text-pizza-red" />
        </div>
        ...
        <div className="flex-shrink-0 text-center space-y-2 relative">
          ...
          />
          <div className="absolute inset-0 bg-cheese-yellow/10 rounded-full blur-xl scale-120 src-guarantee-seal" />
        </div>

        {/* Information block verbatim */}
        <div className="space-y-6 text-center md:text-left relative z-10 flex-grow">
          <div className="space-y-2">
            <h2 className="font-display font-extrabold text-3xl md:text-4xl text-pizza-charcoal">
              Garantia de 7 Dias
            </h2>
            <div className="w-16 h-1 bg-cheese-yellow mx-auto md:mx-0 rounded" />
          </div>
          ...
          <div className="flex items-center justify-center md:justify-start gap-2 text-xs text-gray-500 font-medium">
            ...
            <span>Risco zero para sua pizzaria • Reembolso garantido por lei</span>
          </div>
        </div>
