...
export default function VerticalVideoShowcase() {
  return (
    <section id="demo-video" className="bg-gradient-to-b from-white to-dough-beige/10 pt-4 md:pt-6 pb-8 px-4 border-b border-orange-100">
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        <div className="text-center mb-6">
          <h2 className="font-display font-extrabold text-3xl md:text-5xl text-pizza-charcoal tracking-tight">
            ⚠️<span className="text-pizza-red">ATENÇÃO</span>
          </h2>
        </div>
        ...
        <div className="w-full max-w-[350px] aspect-[9/16] bg-black rounded-3xl shadow-2xl border border-gray-200/50 overflow-hidden relative">
          <iframe
            ...
            src="https://www.youtube.com/embed/j7Yg63-dxUE"
